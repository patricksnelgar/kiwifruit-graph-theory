...
if(!file.exists(
	...
	# imputing types which doesnt work for sparse columns (seed counts etc.)
	
	all_fruit_data <- read_csv(here("workspace/all_fruit_data.csv"), col_types = "iiicccciicDciddddddddddddddiccccccdiiciidiicccii")
	all_arch_data <- read_csv(here("workspace/all_arch_data.csv"), col_types = "iciiccccciiiiiiiidciicccc")
	all_shoot_data <- read_csv(here("workspace/all_shoot_data.csv"), col_types = "iciidlllldccccdd")
}
