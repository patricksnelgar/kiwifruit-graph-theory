...
if(!file.exists(c("workspace/all_fruit_data.csv", 
	...
	all_fruit_data <- read_csv("workspace/all_fruit_data.csv", col_types = "dddccccddcDcdddddddddddddddccc")
...
source("code/visualisation/all_vines_fruit_metrics.R")

```

```{r individual_vine_fruit_metrics, echo = FALSE}

source("code/visualisation/individual_vine_fruit_metrics.R")
