...
#save shapefile
rgdal::writeOGR(rSB,here::here("Rodelyn_part/Data/"),layer="vine_architecture_shapefile", driver="ESRI Shapefile")

write.csv(data.frame(field_names = colnames(rSB@data)),file=here::here('Rodelyn_part/Data/fieldnames.csv'),row.names = F)
