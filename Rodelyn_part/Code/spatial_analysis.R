...
vines_df <- readOGR(here::here("Rodelyn_part/Data/vine_architecture_shapefile.shp"))
vines_df_names <- read.csv(here::here('Rodelyn_part/Data/fieldnames.csv'),header=T)
...
#adjancency matrix or uncomment first line to create
#nb2INLA(here::here("Rodelyn_part/Data/map.adj"), vines_nb)
g <- inla.read.graph(filename = here::here("Rodelyn_part/Data/map.adj"))
#check
